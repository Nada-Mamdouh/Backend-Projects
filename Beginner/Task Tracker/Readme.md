...
* This app uses a JSON file to store the tasks in the current directory and the JSON file should be created if it does not exist.
...
- CreatedAt & UpdatedAt: stored for system use.
